...
public class FavoriteController {
	...
	public FavoriteController(FavoriteRepository favoriteRepository, StoreService storeService) {
	...
	@GetMapping("/favorites/{id}/delete")
	public String delete(@PathVariable(name = "id") Integer storeId,
						 @AuthenticationPrincipal UserDetailsImpl userDetailsImpl,
						 RedirectAttributes redirectAttributes) 
	{
		storeService.favoriteOff(userDetailsImpl.getUser().getId(), storeId);
